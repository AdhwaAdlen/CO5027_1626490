...
<asp:Content ID="Content4" ContentPlaceHolderID="maincontent" runat="server">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtEmail" runat="server" placeholder="Fill in"></asp:TextBox>
        ...
        <asp:TextBox ID="txtBody" TextMode="MultiLine" runat="server" placeholder="Your Message"></asp:TextBox>
